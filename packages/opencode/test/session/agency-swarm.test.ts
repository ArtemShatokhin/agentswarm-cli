...
describe("session.agency-swarm", () => {
  ...
  test("stream preserves OpenRouter keys for legacy LiteLLM OpenRouter routes", async () => {
    mockHistory()
    spyOn(Auth, "all").mockImplementation(async () => ({
      openrouter: { type: "api", key: "stored-openrouter" } as any,
    })) as typeof Auth.all
    ...
    const { input } = helper()
    input.options.clientConfig = {
      model: "litellm/openrouter/openai/gpt-5.2",
    }
  ...
  test("stream preserves explicit OpenRouter max tokens over default tier policy", async () => {
    mockHistory()
    globalThis.fetch = mock(async () => {
      throw new Error("OpenRouter key tier should not be fetched for explicit max_tokens")
  ...
  test("stream preserves explicit OpenRouter extra body fields when applying variants", async () => {
    mockHistory()
  ...
  test("stream does not duplicate new_messages replay for nonzero content index", async () => {
    mockHistory()
    AgencySwarmAdapter.streamRun = async function* () {
      yield {
        type: "data",
        payload: {
          ...
          data: {
            type: "response.output_item.added",
            output_index: "0",
            item: { type: "message", id: "msg_indexed_replay" },
          },
        },
      }
      yield {
        ...
        payload: {
          ...
          data: {
            type: "response.output_text.delta",
            item_id: "msg_indexed_replay",
            content_index: "1",
            output_index: "0",
            delta: "Indexed final text",
          },
        },
      }
      yield {
      ...
      yield {
        ...
        payload: {
          new_messages: [
            {
              type: "message",
              id: "msg_indexed_replay",
              role: "assistant",
              content: [{ type: "output_text", text: "Indexed final text" }],
            },
          ],
        },
      }
  ...
  test("stream emits only missing content from partial indexed replay", async () => {
    mockHistory()
    AgencySwarmAdapter.streamRun = async function* () {
      yield {
        type: "data",
        payload: {
          ...
          data: {
            type: "response.output_item.added",
            output_index: "0",
            item: { type: "message", id: "msg_partial_indexed_replay" },
          },
        },
      }
      yield {
        ...
        payload: {
          ...
          data: {
            type: "response.output_text.delta",
            item_id: "msg_partial_indexed_replay",
            content_index: "1",
            output_index: "0",
            delta: "Second part",
          },
    ...
    expect(deltas).toEqual(["Second part", "First part"])
  })

  test("stream completes partial unindexed replay on joined path", async () => {
    mockHistory()
    AgencySwarmAdapter.streamRun = async function* () {
      yield {
        type: "data",
        payload: {
          ...
          data: {
            type: "response.output_item.added",
            output_index: "0",
            item: { type: "message", id: "msg_partial_unindexed_replay" },
          },
        },
      }
      yield {
        ...
        payload: {
          ...
          data: {
            type: "response.output_text.delta",
            item_id: "msg_partial_unindexed_replay",
            output_index: "0",
            delta: "First part\nSe",
          },
        },
      ...
      yield {
        ...
        payload: {
          new_messages: [
            {
              type: "message",
              id: "msg_partial_unindexed_replay",
              role: "assistant",
              content: [
                { type: "output_text", text: "First part" },
                { type: "output_text", text: "Second part" },
